...
```bash
scp -r custom_components/boum_garden root@<HOME_ASSISTANT_IP>:/docker/homeassistant/custom_components/
```
...
Wenn die Boum API keine Pflanzennamen liefert, nutzt die Integration als Fallback Beispielhafte Topf-Zuordnung:
